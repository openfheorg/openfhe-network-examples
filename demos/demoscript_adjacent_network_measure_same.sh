...
tmux send 'bin/thresh_client_measure -i localhost -p 12345 -o localhost:50051 -d 1 -n Node1 -m 2 -s 1 -f demoData/threshnet_input_file_same '$ssl_cert_path ENTER

sleep 3
tmux select-pane -t 4
printf "Starting Node2\n"
tmux send 'bin/thresh_client_measure -i localhost -p 12345 -o localhost:50051 -d 2 -n Node2 -m 2 -s 1 -f demoData/threshnet_input_file_same '$ssl_cert_path ENTER
