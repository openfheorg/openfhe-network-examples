...
tmux send 'bin/network_measure -n Node1 -s localhost:50051 -m ../NetworkMaps/NetworkMap_nm.txt -f demoData/threshnet_input_file_same '$ssl_cert_path ENTER

sleep 3
tmux select-pane -t 2
printf "Starting Node2\n"
tmux send 'bin/network_measure -n Node2 -s localhost:50052 -m ../NetworkMaps/NetworkMap_nm.txt -f demoData/threshnet_input_file_same '$ssl_cert_path ENTER
