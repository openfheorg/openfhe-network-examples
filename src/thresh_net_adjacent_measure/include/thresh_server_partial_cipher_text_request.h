...
class PartialCipherTextRequestServicer : public CallData<thresh_net::ThreshServer::AsyncService> {
public:
	...
	void Proceed() override {
		if (status_ == CREATE) {
			...
			//if (!ct)
			//	OPENFHE_THROW(lbcrypto::deserialize_error, "Partial CipherText de-serialization error");
