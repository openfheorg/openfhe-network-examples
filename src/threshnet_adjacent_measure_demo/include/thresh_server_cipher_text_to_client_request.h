...
class CipherTextToClientRequestServicer : public CallData<thresh_net::ThreshServer::AsyncService> {
public:
	...
	void Proceed() override {
		if (status_ == CREATE) {
			...
			// Spawn a new CipherTextFromBrokerRequestServicer instance to serve new clients while we process
			// the one for this CipherTextFromBrokerRequestServicer. The instance will deallocate itself as
