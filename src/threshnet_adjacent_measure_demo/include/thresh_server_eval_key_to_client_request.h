...
class EvalMultKeyToClientRequestServicer : public CallData<thresh_net::ThreshServer::AsyncService> {
public:
	...
	void Proceed() override {
		if (status_ == CREATE) {
			...
			// Spawn a new EvalMultKeyToClientRequestServicer instance to serve new clients while we process
			// the one for this EvalMultKeyToClientRequestServicer. The instance will deallocate itself as
