...
`sudo docker run -d --network host -p 50050-50055:50050-50055 -p 50060-50065:50060-50065 -p 50070-50075:50070-50075 -v /palisades/certs:/certs palisades-examples:jammy bash -c "${run_command} -${ssl_arg}" > docker_container_id_b`
