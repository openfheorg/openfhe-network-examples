...
`sudo docker run -d --network host -p 50050:50050 -p 50051:50051 -p 50052:50052 -v /palisades/AccessMaps:/AccessMaps -v /palisades/certs:/certs palisades-examples:jammy bash -c "${run_command} -${ssl_arg}" > docker_container_id_s`
